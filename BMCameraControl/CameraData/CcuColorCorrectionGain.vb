...
Namespace CameraData
    Public Class CcuColorCorrectionGain
        Inherits CameraControl

        Public MinValue As Double = 0
        Public MaxValue As Double = 16.0
        ...
        Private _ValueGreen As Double = 1
        ...
        Private _ValueBlue As Double = 1
        ...
        Private _ValueLuma As Double = 1
