...
Namespace CameraData
    ...
    Public Class CcuColorCorrectionLift
        Inherits CameraControl

        Public MinValue As Double = -2.0
        Public MaxValue As Double = 2.0

        Public Sub New()
        End Sub

        'todo:ColorCorrection Lift
        ...
        <JsonProperty()> _
        Public Property ValueRed() As Double
            Get
                Return _ValueRed
            End Get
        ...
        Public Property ValueRed(autoSend As Boolean) As Double
            Get
                Return _ValueRed
            End Get
            Set(ByVal inValue As Double)
        ...
        <JsonProperty()> _
        Public Property ValueGreen() As Double
            Get
                Return _ValueGreen
            End Get
            Set(ByVal inValue As Double)
        ...
        Public Property ValueGreen(autoSend As Boolean) As Double
            Get
                Return _ValueGreen
            End Get
            Set(ByVal inValue As Double)
        ...
        <JsonProperty()> _
        Public Property ValueBlue() As Double
            Get
                Return _ValueBlue
            End Get
            Set(ByVal inValue As Double)
        ...
        Public Property ValueBlue(autoSend As Boolean) As Double
            Get
                Return _ValueBlue
            End Get
            Set(ByVal inValue As Double)
        ...
        <JsonProperty()> _
        Public Property ValueLuma() As Double
            Get
                Return _ValueLuma
            End Get
            Set(ByVal inValue As Double)
        ...
        Public Property ValueLuma(autoSend As Boolean) As Double
            Get
                Return _ValueLuma
            End Get
            Set(ByVal inValue As Double)
